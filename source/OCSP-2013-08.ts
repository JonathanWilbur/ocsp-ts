/*
    BEGIN_MODULE OCSP-2013-08
    OID: iso.identified-organization.dod.internet.security.mechanisms.pkix.id-mod.id-mod-ocsp-2013-08
    IRI: undefined
    EXTENSIBLE: false
...
} from "x500-ts/dist/node/PkiPmiExternalDataTypes";
import { id_kp } from "x500-ts/dist/node/UsefulDefinitions";
...
export function _decode_CertID(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertID) {
        _cached_decoder_for_CertID = function (el: asn1.ASN1Element): CertID {
...
export function _encode_CertID(
    value: CertID,
    elGetter: __utils.ASN1Encoder<CertID>
) {
    ...
    if (!_cached_decoder_for_Request) {
        _cached_decoder_for_Request = function (el: asn1.ASN1Element): Request {
            ...
            const callbacks: __utils.DecodingMap = {
                reqCert: (_el: asn1.ASN1Element): void => {
                    reqCert = _decode_CertID(_el);
                },
                singleRequestExtensions: (_el: asn1.ASN1Element): void => {
                    singleRequestExtensions = __utils._decode_explicit<
                        Extensions
                    >(() => _decode_Extensions)(_el);
                },
            };
                    ...
                    .concat([
                        ...
                        undefined
                            ...
                            : __utils._encode_explicit(
                                  ...
                                  () => _encode_Extensions,
                                  __utils.BER
                              )(value.singleRequestExtensions, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_TBSRequest: __utils.ASN1Decoder<
    TBSRequest
> | null = null;
let _cached_encoder_for_TBSRequest: __utils.ASN1Encoder<
    TBSRequest
> | null = null;
export function _decode_TBSRequest(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_TBSRequest) {
        _cached_decoder_for_TBSRequest = function (
            el: asn1.ASN1Element
        ): TBSRequest {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                requestorName: (_el: asn1.ASN1Element): void => {
                    requestorName = __utils._decode_explicit<GeneralName>(
                        () => _decode_GeneralName
                    )(_el);
                },
                requestList: (_el: asn1.ASN1Element): void => {
                    requestList = __utils._decodeSequenceOf<Request>(
                        () => _decode_Request
                    )(_el);
                },
                requestExtensions: (_el: asn1.ASN1Element): void => {
                    requestExtensions = __utils._decode_explicit<Extensions>(
                        () => _decode_Extensions
                    )(_el);
                },
            };
...
export function _encode_TBSRequest(
    value: TBSRequest,
    elGetter: __utils.ASN1Encoder<TBSRequest>
) {
            ...
            return __utils._encodeSequence(
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        /* REQUIRED   */ __utils._encodeSequenceOf<Request>(
                            () => _encode_Request,
                            __utils.BER
                        )(value.requestList, __utils.BER),
        ...
        _cached_decoder_for_Signature = function (
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                certs: (_el: asn1.ASN1Element): void => {
                    certs = __utils._decode_explicit<Certificate[]>(() =>
                        __utils._decodeSequenceOf<Certificate>(
                            () => _decode_Certificate
                        )
                    )(_el);
                },
                    ...
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.certs === undefined
                            ...
                            : __utils._encode_explicit(
                                  ...
                                  0,
                                  () =>
                                      __utils._encodeSequenceOf<Certificate>(
                                          () => _encode_Certificate,
                                          __utils.BER
                                      ),
                                  __utils.BER
...
let _cached_decoder_for_OCSPRequest: __utils.ASN1Decoder<
    OCSPRequest
> | null = null;
let _cached_encoder_for_OCSPRequest: __utils.ASN1Encoder<
    OCSPRequest
> | null = null;
export function _decode_OCSPRequest(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_OCSPRequest) {
        _cached_decoder_for_OCSPRequest = function (
            el: asn1.ASN1Element
        ): OCSPRequest {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                tbsRequest: (_el: asn1.ASN1Element): void => {
                    tbsRequest = _decode_TBSRequest(_el);
                },
                optionalSignature: (_el: asn1.ASN1Element): void => {
                    optionalSignature = __utils._decode_explicit<Signature>(
                        () => _decode_Signature
                    )(_el);
                },
            };
...
export function _encode_OCSPRequest(
    value: OCSPRequest,
    elGetter: __utils.ASN1Encoder<OCSPRequest>
) {
                    ...
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.optionalSignature === undefined
                            ...
                            : __utils._encode_explicit(
                                  ...
                                  () => _encode_Signature,
                                  __utils.BER
                              )(value.optionalSignature, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_OCSPResponseStatus: __utils.ASN1Decoder<
    OCSPResponseStatus
> | null = null;
let _cached_encoder_for_OCSPResponseStatus: __utils.ASN1Encoder<
    OCSPResponseStatus
> | null = null;
export function _decode_OCSPResponseStatus(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_OCSPResponseStatus) {
        _cached_decoder_for_OCSPResponseStatus = __utils._decodeEnumerated;
    }
    return _cached_decoder_for_OCSPResponseStatus(el);
}
export function _encode_OCSPResponseStatus(
    value: OCSPResponseStatus,
    elGetter: __utils.ASN1Encoder<OCSPResponseStatus>
) {
    if (!_cached_encoder_for_OCSPResponseStatus) {
        _cached_encoder_for_OCSPResponseStatus = __utils._encodeEnumerated;
    }
...
let _cached_decoder_for_ResponseBytes: __utils.ASN1Decoder<
    ResponseBytes
> | null = null;
let _cached_encoder_for_ResponseBytes: __utils.ASN1Encoder<
    ResponseBytes
> | null = null;
...
export function _encode_ResponseBytes(
    value: ResponseBytes,
    elGetter: __utils.ASN1Encoder<ResponseBytes>
) {
...
let _cached_decoder_for_OCSPResponse: __utils.ASN1Decoder<
    OCSPResponse
> | null = null;
let _cached_encoder_for_OCSPResponse: __utils.ASN1Encoder<
    OCSPResponse
> | null = null;
    ...
    if (!_cached_decoder_for_OCSPResponse) {
        _cached_decoder_for_OCSPResponse = function (
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                responseBytes: (_el: asn1.ASN1Element): void => {
                    responseBytes = __utils._decode_explicit<ResponseBytes>(
...
export function _encode_OCSPResponse(
    value: OCSPResponse,
    elGetter: __utils.ASN1Encoder<OCSPResponse>
) {
                    ...
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.responseBytes === undefined
                            ...
                            : __utils._encode_explicit(
                                  ...
                                  __utils.BER
                              )(value.responseBytes, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
export function _decode_KeyHash(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_KeyHash) {
        _cached_decoder_for_KeyHash = __utils._decodeOctetString;
    }
    return _cached_decoder_for_KeyHash(el);
}
export function _encode_KeyHash(
    value: KeyHash,
    elGetter: __utils.ASN1Encoder<KeyHash>
) {
    if (!_cached_encoder_for_KeyHash) {
        _cached_encoder_for_KeyHash = __utils._encodeOctetString;
    }
...
let _cached_decoder_for_ResponderID: __utils.ASN1Decoder<
    ResponderID
> | null = null;
let _cached_encoder_for_ResponderID: __utils.ASN1Encoder<
    ResponderID
> | null = null;
export function _decode_ResponderID(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ResponderID) {
        _cached_decoder_for_ResponderID = __utils._decode_inextensible_choice<
            ResponderID
        >({
            "CONTEXT 1": [
                "byName",
            ...
            "CONTEXT 2": [
                "byKey",
                __utils._decode_explicit<KeyHash>(() => _decode_KeyHash),
            ],
        });
    }
...
export function _encode_ResponderID(
    value: ResponderID,
    elGetter: __utils.ASN1Encoder<ResponderID>
) {
    if (!_cached_encoder_for_ResponderID) {
        _cached_encoder_for_ResponderID = __utils._encode_choice<ResponderID>(
            {
                byName: __utils._encode_explicit(
                    asn1.ASN1TagClass.context,
                    1,
                    () => _encode_Name,
                    __utils.BER
                ),
                byKey: __utils._encode_explicit(
                    asn1.ASN1TagClass.context,
                    2,
                    () => _encode_KeyHash,
                    __utils.BER
...
export const _root_component_type_list_1_spec_for_RevokedInfo: __utils.ComponentSpec[] = [
    ...
    new __utils.ComponentSpec(
        ...
        __utils.hasTag(
            ...
            asn1.ASN1UniversalType.enumerated
        ),
        undefined,
        undefined
    ),
...
let _cached_decoder_for_RevokedInfo: __utils.ASN1Decoder<
    RevokedInfo
> | null = null;
let _cached_encoder_for_RevokedInfo: __utils.ASN1Encoder<
    RevokedInfo
> | null = null;
export function _decode_RevokedInfo(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_RevokedInfo) {
        _cached_decoder_for_RevokedInfo = function (
            el: asn1.ASN1Element
        ): RevokedInfo {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                revocationReason: (_el: asn1.ASN1Element): void => {
                    revocationReason = __utils._decode_explicit<CRLReason>(
                        () => _decode_CRLReason
                    )(_el);
                },
            };
...
export function _encode_RevokedInfo(
    value: RevokedInfo,
    elGetter: __utils.ASN1Encoder<RevokedInfo>
) {
                    ...
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.revocationReason === undefined
                            ...
                            : __utils._encode_explicit(
                                  ...
                                  () => _encode_CRLReason,
                                  __utils.BER
                              )(value.revocationReason, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_UnknownInfo: __utils.ASN1Decoder<
    UnknownInfo
> | null = null;
let _cached_encoder_for_UnknownInfo: __utils.ASN1Encoder<
    UnknownInfo
> | null = null;
export function _decode_UnknownInfo(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_UnknownInfo) {
        _cached_decoder_for_UnknownInfo = __utils._decodeNull;
    }
    return _cached_decoder_for_UnknownInfo(el);
}
export function _encode_UnknownInfo(
    value: UnknownInfo,
    elGetter: __utils.ASN1Encoder<UnknownInfo>
) {
    if (!_cached_encoder_for_UnknownInfo) {
        _cached_encoder_for_UnknownInfo = __utils._encodeNull;
    }
...
export function _decode_CertStatus(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CertStatus) {
        _cached_decoder_for_CertStatus = __utils._decode_inextensible_choice<
            CertStatus
        >({
            "CONTEXT 0": [
                "good",
            ...
            "CONTEXT 1": [
                "revoked",
                __utils._decode_explicit<RevokedInfo>(
                    () => _decode_RevokedInfo
                ),
            ],
            "CONTEXT 2": [
                "unknown",
                __utils._decode_explicit<UnknownInfo>(
                    () => _decode_UnknownInfo
                ),
            ],
        });
...
export function _encode_CertStatus(
    ...
    if (!_cached_encoder_for_CertStatus) {
        _cached_encoder_for_CertStatus = __utils._encode_choice<CertStatus>(
            {
                good: __utils._encode_explicit(
                    asn1.ASN1TagClass.context,
                    0,
                    () => __utils._encodeNull,
                    __utils.BER
                ),
                revoked: __utils._encode_explicit(
                    asn1.ASN1TagClass.context,
                    1,
                    () => _encode_RevokedInfo,
                    __utils.BER
                ),
                unknown: __utils._encode_explicit(
                    asn1.ASN1TagClass.context,
                    2,
                    () => _encode_UnknownInfo,
                    __utils.BER
...
let _cached_decoder_for_SingleResponse: __utils.ASN1Decoder<
    SingleResponse
> | null = null;
let _cached_encoder_for_SingleResponse: __utils.ASN1Encoder<
    SingleResponse
> | null = null;
    ...
    if (!_cached_decoder_for_SingleResponse) {
        _cached_decoder_for_SingleResponse = function (
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                certStatus: (_el: asn1.ASN1Element): void => {
                ...
                nextUpdate: (_el: asn1.ASN1Element): void => {
                    nextUpdate = __utils._decode_explicit<asn1.GeneralizedTime>(
                        () => __utils._decodeGeneralizedTime
                    )(_el);
                },
                singleExtensions: (_el: asn1.ASN1Element): void => {
                    singleExtensions = __utils._decode_explicit<Extensions>(
                        () => _decode_Extensions
                    )(_el);
                },
            };
...
export function _encode_SingleResponse(
    ...
    elGetter: __utils.ASN1Encoder<SingleResponse>
) {
                    ...
                    .concat([
                        ...
                        /* IF_ABSENT  */ value.singleExtensions === undefined
                            ...
                            : __utils._encode_explicit(
                                  ...
                                  () => _encode_Extensions,
                                  __utils.BER
                              )(value.singleExtensions, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_ResponseData: __utils.ASN1Decoder<
    ResponseData
> | null = null;
let _cached_encoder_for_ResponseData: __utils.ASN1Encoder<
    ResponseData
> | null = null;
    ...
    if (!_cached_decoder_for_ResponseData) {
        _cached_decoder_for_ResponseData = function (
            ...
            const callbacks: __utils.DecodingMap = {
                ...
                responderID: (_el: asn1.ASN1Element): void => {
                    responderID = _decode_ResponderID(_el);
                },
                producedAt: (_el: asn1.ASN1Element): void => {
                    producedAt = __utils._decodeGeneralizedTime(_el);
                },
                responses: (_el: asn1.ASN1Element): void => {
                    responses = __utils._decodeSequenceOf<SingleResponse>(
                        () => _decode_SingleResponse
                    )(_el);
                },
                responseExtensions: (_el: asn1.ASN1Element): void => {
                    responseExtensions = __utils._decode_explicit<Extensions>(
                        () => _decode_Extensions
                    )(_el);
                },
            };
...
export function _encode_ResponseData(
    value: ResponseData,
    elGetter: __utils.ASN1Encoder<ResponseData>
) {
                ...
                ([] as (asn1.ASN1Element | undefined)[])
                    .concat([
                        ...
                        /* REQUIRED   */ __utils._encodeSequenceOf<
                            SingleResponse
                        >(() => _encode_SingleResponse, __utils.BER)(
                            value.responses,
                            __utils.BER
                        ),
                        /* IF_ABSENT  */ value.responseExtensions === undefined
                            ...
                            : __utils._encode_explicit(
                                  ...
                                  () => _encode_Extensions,
                                  __utils.BER
                              )(value.responseExtensions, __utils.BER),
                    ])
                    .filter(
                        (c: asn1.ASN1Element | undefined): boolean => !!c
                    ) as asn1.ASN1Element[],
...
let _cached_decoder_for_BasicOCSPResponse: __utils.ASN1Decoder<
    BasicOCSPResponse
> | null = null;
let _cached_encoder_for_BasicOCSPResponse: __utils.ASN1Encoder<
    BasicOCSPResponse
> | null = null;
export function _decode_BasicOCSPResponse(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_BasicOCSPResponse) {
        _cached_decoder_for_BasicOCSPResponse = function (
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                tbsResponseData: (_el: asn1.ASN1Element): void => {
...
export function _encode_BasicOCSPResponse(
    ...
    elGetter: __utils.ASN1Encoder<BasicOCSPResponse>
) {
...
let _cached_decoder_for_ArchiveCutoff: __utils.ASN1Decoder<
    ArchiveCutoff
> | null = null;
let _cached_encoder_for_ArchiveCutoff: __utils.ASN1Encoder<
    ArchiveCutoff
> | null = null;
export function _decode_ArchiveCutoff(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_ArchiveCutoff) {
        _cached_decoder_for_ArchiveCutoff = __utils._decodeGeneralizedTime;
    }
    return _cached_decoder_for_ArchiveCutoff(el);
}
export function _encode_ArchiveCutoff(
    value: ArchiveCutoff,
    elGetter: __utils.ASN1Encoder<ArchiveCutoff>
) {
    if (!_cached_encoder_for_ArchiveCutoff) {
        _cached_encoder_for_ArchiveCutoff = __utils._encodeGeneralizedTime;
    }
...
let _cached_decoder_for_AcceptableResponses: __utils.ASN1Decoder<
    AcceptableResponses
> | null = null;
let _cached_encoder_for_AcceptableResponses: __utils.ASN1Encoder<
    AcceptableResponses
> | null = null;
export function _decode_AcceptableResponses(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_AcceptableResponses) {
        _cached_decoder_for_AcceptableResponses = __utils._decodeSequenceOf<
...
export function _encode_AcceptableResponses(
    ...
    elGetter: __utils.ASN1Encoder<AcceptableResponses>
) {
    if (!_cached_encoder_for_AcceptableResponses) {
        _cached_encoder_for_AcceptableResponses = __utils._encodeSequenceOf<
            asn1.OBJECT_IDENTIFIER
...
let _cached_decoder_for_ServiceLocator: __utils.ASN1Decoder<
    ServiceLocator
> | null = null;
let _cached_encoder_for_ServiceLocator: __utils.ASN1Encoder<
    ServiceLocator
> | null = null;
...
export function _encode_ServiceLocator(
    ...
    elGetter: __utils.ASN1Encoder<ServiceLocator>
) {
...
export function _decode_CrlID(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_CrlID) {
        _cached_decoder_for_CrlID = function (el: asn1.ASN1Element): CrlID {
            /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            ...
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                crlUrl: (_el: asn1.ASN1Element): void => {
                    crlUrl = __utils._decode_explicit<asn1.IA5String>(
                        () => __utils._decodeIA5String
                    )(_el);
                },
                crlNum: (_el: asn1.ASN1Element): void => {
                    crlNum = __utils._decode_explicit<asn1.INTEGER>(
                        () => __utils._decodeInteger
                    )(_el);
                },
                crlTime: (_el: asn1.ASN1Element): void => {
                    crlTime = __utils._decode_explicit<asn1.GeneralizedTime>(
                        () => __utils._decodeGeneralizedTime
                    )(_el);
                },
            };
...
export function _encode_CrlID(
    value: CrlID,
    elGetter: __utils.ASN1Encoder<CrlID>
) {
...
export class PreferredSignatureAlgorithm {
    constructor(
        ...
        readonly certIdentifier: asn1.OPTIONAL<AlgorithmIdentifier>
    ) {}
}
export const _root_component_type_list_1_spec_for_PreferredSignatureAlgorithm: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec(
        "sigIdentifier",
        false,
        __utils.hasTag(asn1.ASN1TagClass.universal, 16),
...
export const _root_component_type_list_2_spec_for_PreferredSignatureAlgorithm: __utils.ComponentSpec[] = [];
export const _extension_additions_list_spec_for_PreferredSignatureAlgorithm: __utils.ComponentSpec[] = [];
let _cached_decoder_for_PreferredSignatureAlgorithm: __utils.ASN1Decoder<
    PreferredSignatureAlgorithm
> | null = null;
let _cached_encoder_for_PreferredSignatureAlgorithm: __utils.ASN1Encoder<
    PreferredSignatureAlgorithm
> | null = null;
export function _decode_PreferredSignatureAlgorithm(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PreferredSignatureAlgorithm) {
        _cached_decoder_for_PreferredSignatureAlgorithm = function (
            ...
            let certIdentifier: asn1.OPTIONAL<AlgorithmIdentifier>;
            /* END_OF_SEQUENCE_COMPONENT_DECLARATIONS */
            /* START_OF_CALLBACKS_MAP */
            const callbacks: __utils.DecodingMap = {
                sigIdentifier: (_el: asn1.ASN1Element): void => {
                    sigIdentifier = _decode_AlgorithmIdentifier(_el);
                },
                certIdentifier: (_el: asn1.ASN1Element): void => {
            ...
            return new PreferredSignatureAlgorithm /* SEQUENCE_CONSTRUCTOR_CALL */(
                sigIdentifier,
                certIdentifier
            );
        };
...
export function _encode_PreferredSignatureAlgorithm(
    ...
    elGetter: __utils.ASN1Encoder<PreferredSignatureAlgorithm>
) {
...
let _cached_decoder_for_PreferredSignatureAlgorithms: __utils.ASN1Decoder<
    PreferredSignatureAlgorithms
> | null = null;
let _cached_encoder_for_PreferredSignatureAlgorithms: __utils.ASN1Encoder<
    PreferredSignatureAlgorithms
> | null = null;
export function _decode_PreferredSignatureAlgorithms(el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PreferredSignatureAlgorithms) {
        _cached_decoder_for_PreferredSignatureAlgorithms = __utils._decodeSequenceOf<
            PreferredSignatureAlgorithm
...
export function _encode_PreferredSignatureAlgorithms(
    ...
    elGetter: __utils.ASN1Encoder<PreferredSignatureAlgorithms>
) {
    if (!_cached_encoder_for_PreferredSignatureAlgorithms) {
        _cached_encoder_for_PreferredSignatureAlgorithms = __utils._encodeSequenceOf<
            PreferredSignatureAlgorithm
        >(() => _encode_PreferredSignatureAlgorithm, __utils.BER);
    }
    return _cached_encoder_for_PreferredSignatureAlgorithms(value, elGetter);
}

// TODO: ObjectAssignment: ext-ocsp-nocheck
...
// TODO: ObjectAssignment: re-ocsp-preferred-signature-algorithms

// TODO: ObjectAssignment: re-ocsp-crl

// TODO: ObjectAssignment: re-ocsp-archive-cutoff

// TODO: ObjectAssignment: re-ocsp-extended-revoke
...
export const id_pkix_ocsp_pref_sig_algs: asn1.OBJECT_IDENTIFIER = new asn1.ObjectIdentifier(
    [8],
    id_pkix_ocsp
);

export const id_pkix_ocsp_extended_revoke: asn1.OBJECT_IDENTIFIER = new asn1.ObjectIdentifier(
    [9],
    id_pkix_ocsp
);

/* END_MODULE OCSP-2013-08 */
