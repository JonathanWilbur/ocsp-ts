...
export const _root_component_type_list_1_spec_for_RevokedInfo: __utils.ComponentSpec[] = [
    ...
    /* FIXME: revocationReason COULD_NOT_RESOLVE_TYPE_DEF */
];
...
export const _root_component_type_list_1_spec_for_PreferredSignatureAlgorithm: __utils.ComponentSpec[] = [
    new __utils.ComponentSpec("sigIdentifier", false, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined),
    new __utils.ComponentSpec("certIdentifier", true, __utils.hasTag(asn1.ASN1TagClass.universal, 16), undefined, undefined)
];
...
let _cached_decoder_for_PreferredSignatureAlgorithm: __utils.ASN1Decoder<PreferredSignatureAlgorithm> | null = null;
let _cached_encoder_for_PreferredSignatureAlgorithm: __utils.ASN1Encoder<PreferredSignatureAlgorithm> | null = null;
export function _decode_PreferredSignatureAlgorithm (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PreferredSignatureAlgorithm) { _cached_decoder_for_PreferredSignatureAlgorithm = function (el: asn1.ASN1Element): PreferredSignatureAlgorithm {
    /* START_OF_SEQUENCE_COMPONENT_DECLARATIONS */
    ...
    /* START_OF_CALLBACKS_MAP */
    const callbacks: __utils.DecodingMap = {
        "sigIdentifier": (_el: asn1.ASN1Element): void => { sigIdentifier = _decode_AlgorithmIdentifier(_el); },
        "certIdentifier": (_el: asn1.ASN1Element): void => { certIdentifier = _decode_AlgorithmIdentifier(_el); }
    };
    /* END_OF_CALLBACKS_MAP */
    __utils._parse_sequence(el, callbacks,
...
export function _encode_PreferredSignatureAlgorithm (value: PreferredSignatureAlgorithm, elGetter: __utils.ASN1Encoder<PreferredSignatureAlgorithm>) {
    if (!_cached_encoder_for_PreferredSignatureAlgorithm) { _cached_encoder_for_PreferredSignatureAlgorithm = function (value: PreferredSignatureAlgorithm, elGetter: __utils.ASN1Encoder<PreferredSignatureAlgorithm>): asn1.ASN1Element {
    return __utils._encodeSequence(([] as (asn1.ASN1Element | undefined)[]).concat(
        [
            /* REQUIRED   */ _encode_AlgorithmIdentifier(value.sigIdentifier, __utils.BER),
            /* IF_ABSENT  */ ((value.certIdentifier === undefined) ? undefined : _encode_AlgorithmIdentifier(value.certIdentifier, __utils.BER))
        ],
    ).filter((c: (asn1.ASN1Element | undefined)): boolean => (!!c)) as asn1.ASN1Element[], __utils.BER);
}; }
...
let _cached_decoder_for_PreferredSignatureAlgorithms: __utils.ASN1Decoder<PreferredSignatureAlgorithms> | null = null;
let _cached_encoder_for_PreferredSignatureAlgorithms: __utils.ASN1Encoder<PreferredSignatureAlgorithms> | null = null;
export function _decode_PreferredSignatureAlgorithms (el: asn1.ASN1Element) {
    if (!_cached_decoder_for_PreferredSignatureAlgorithms) { _cached_decoder_for_PreferredSignatureAlgorithms = __utils._decodeSequenceOf<PreferredSignatureAlgorithm>(() => _decode_PreferredSignatureAlgorithm); }
    return _cached_decoder_for_PreferredSignatureAlgorithms(el);
}
export function _encode_PreferredSignatureAlgorithms (value: PreferredSignatureAlgorithms, elGetter: __utils.ASN1Encoder<PreferredSignatureAlgorithms>) {
    if (!_cached_encoder_for_PreferredSignatureAlgorithms) { _cached_encoder_for_PreferredSignatureAlgorithms = __utils._encodeSequenceOf<PreferredSignatureAlgorithm>(() => _encode_PreferredSignatureAlgorithm, __utils.BER); }
